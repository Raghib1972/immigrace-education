...
const WHATSAPP_LINK =
  "https://wa.me/918130464466?text=Hi%20Immigrace%20Education,%20I%20want%20to%20book%20a%20free%20consultation.";
      ...
      >
        <div className="max-w-7xl mx-auto px-4 h-16 sm:h-20 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src={logo} alt="Immigrace" className="h-9 w-9" />
            <div>
              <p className="font-bold text-slate-900">Immigrace</p>
          ...
          <div className="hidden lg:flex items-center gap-8 text-sm">
            ...
            <NavLink to="/career-counselling" className={navLinkClass}>
              Career Counselling
            </NavLink>
            <NavLink to="/study-abroad" className={navLinkClass}>
              Study Abroad
            </NavLink>
            <NavLink to="/test-preparation" className={navLinkClass}>
              Test Preparation
            </NavLink>
          ...
          <button
            onClick={() => setOpen(!open)}
            className="lg:hidden w-10 h-10 flex items-center justify-center bg-blue-600 text-white rounded-md"
          >
            {open ? <X /> : <Menu />}
          </button>
        </div>
        ...
        {/* MOBILE MENU */}
        {open && (
          <div className="lg:hidden bg-white border-t px-4 py-6 space-y-2">
            {[
              ["Home", "/"],
              ["About", "/about"],
